...
#+BEGIN_SRC emacs-lisp
  (use-package modus-themes
    ...
    (setq modus-themes-headings
          '((1 . (background  overline rainbow variable-pitch 1.7))
            (2 . (background overline rainbow variable-pitch 1.5))
            (3 . (background overline rainbow 1.3))
            (4 . (background overline rainbow 1.1))
            (t . (monochrome))))
